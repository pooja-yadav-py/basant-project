...
const Signup = () => {
  ...
  const [wait, setWait] = useState("Signup");
      ...
      <div className="signup-container">
        ...
        {showError ? (
          <span className="text-danger mb-1">
            ⚠️ please fill the all field properly.
          </span>
        ) : (
          ""
        )}
        {passwordError ? (
          <span className="text-danger mb-1">
            ⚠️ please confirm password check.
          </span>
        ) : (
          ""
        )}
        ...
        <div className="mb-3">
          ...
          />
          &nbsp;
          <label className="gender me-3" for="male">
            Male
          </label>
          <input
          ...
          />
          &nbsp;
          <label className="gender me-3" for="female">
            Female
          </label>
          <input
          ...
          />
          &nbsp;
          <label className="gender me-3" for="other">
            Other
          </label>
          <br></br>
        </div>
